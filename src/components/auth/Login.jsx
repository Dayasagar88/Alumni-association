        ...
        <section className="w-full py-12 flex justify-center md:py-24 lg:py-32">
          <div className="container">
            <div className="flex flex-col w-full items-center justify-center space-y-6">
              ...
              <div className="h-[50vh] min-w-[50%]  flex rounded-lg shadow-lg justify-center  mx-8 border">
                <img
                  className="mx-auto lg:block hidden border-r aspect-video overflow-hidden rounded-l-lg object-cove sm:w-full lg:aspect-square"
                  src="https://www.just.edu.jo/Units_and_offices/Offices/IRO/PublishingImages/Pages/AlumniMain/alumni-global-network-final%20(2).png"
                  alt="poster"
                />
                <Card className="w-full flex flex-col justify-evenly py-2 max-w-md lg:rounded-l-none shadow-none border-none">
